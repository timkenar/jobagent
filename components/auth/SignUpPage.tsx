...
import { signUpUser, signInUser, initializeGoogleSignIn, initializeLinkedInSignIn } from '../../services/geminiService';
      ...
      <div className="relative z-10 bg-gray-800/50 backdrop-blur-sm p-6 sm:p-10 rounded-3xl shadow-2xl w-full max-w-md transition-all duration-300 border border-gray-700">
        ...
        <div ref={googleRef} className="mb-6 flex flex-col items-center space-y-3">
          ...
          <button
            ...
            onClick={() => {
              setIsLoading(true);
              initializeLinkedInSignIn().catch((err) => {
            ...
            disabled={isLoading}
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-xl shadow-md transition-all duration-300 hover:scale-105 flex items-center justify-center text-base border border-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
          >
